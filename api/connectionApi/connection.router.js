const {sendFriendRequest, deleteAcceptedRequest,deletePendingRequest,getPendingRequest,getRequest,acceptFriendRequest,rejectFriendRequest}= require('./connection.controller');
